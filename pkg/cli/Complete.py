...
# declaration
class Complete(flexi.shells.command, family="flexi.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = flexi.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = flexi.properties.str()
    line.doc = "the partial command line"


    # administrative
    @flexi.export(tip="generate completions candidates from a partial command line")
